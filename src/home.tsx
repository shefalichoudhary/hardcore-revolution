  ...
  return (
    <>
      ...
      <div className="md:min-h-screen relative bg-cover bg-center bg-no-repeat bg-[url('../public/Img.jpg')]">
        ...
        {/* Hero Content */}
        <div className="relative z-10 flex flex-col justify-center items-center text-white text-center font-serif px-4 py-20 sm:py-24 md:py-28">
      ...
      <section className="max-w-7xl mx-auto px-2 py-6 sm:px-4 sm:py-10 flex flex-col md:flex-row items-center gap-10">
        ...
        {/* Images: show after text on mobile, left on desktop, animate left-to-right */}
        <motion.div
          ref={fitnessImgRef}
          initial={{ opacity: 0, x: -80 }}
          animate={fitnessImgInView ? { opacity: 1, x: 0 } : {}}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="order-2 w-full max-w-xs xs:max-w-sm sm:max-w-md md:max-w-md lg:max-w-xl flex-shrink-0 min-h-[340px] sm:min-h-[400px] md:min-h-[480px] lg:min-h-[600px] flex items-center justify-center relative overflow-visible"
        >
          {/* Main Circle (Fitness) */}
          ...
          {/* Rotated Rectangle (Wellness) - hidden on mobile */}
          <div className="hidden md:block absolute right-0 top-0 w-24 h-20 xs:w-32 xs:h-28 sm:w-36 sm:h-32 md:w-44 md:h-36 lg:w-72 lg:h-44 rounded-2xl overflow-hidden shadow-xl border-4 border-yellow-400 z-20 -rotate-6 group transition-all duration-300">
            <img
              src="/wellness.jpg"
              alt="Wellness"
              className="w-full h-full object-cover group-hover:scale-105 transition-all duration-300"
  ...
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="relative flex justify-center">
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8 justify-center items-stretch w-full">
        {/* Basic */}
        <div className="flex-1 bg-white rounded-3xl shadow-xl border-2 border-yellow-400 p-6 flex flex-col items-center hover:scale-105 transition-transform duration-300">
          <div className="mb-3">
            <span className="inline-block text-yellow-700 text-lg font-bold mb-1">Basic</span>
          </div>
          <div className="mb-5">
          ...
          <ul className="text-gray-700 mb-6 space-y-2 text-left w-full max-w-xs mx-auto">
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> Gym Access</li>
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> Group Classes</li>
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> Locker Room</li>
          </ul>
          <button className="w-full py-2 bg-yellow-500 text-white rounded-xl font-semibold hover:bg-yellow-600 transition">Join Basic</button>
        </div>
        {/* Premium - Highlighted */}
        <div className="flex-1 bg-yellow-50 border-4 border-yellow-500 rounded-3xl shadow-2xl p-7 flex flex-col items-center scale-105 z-10 relative hover:scale-110 transition-transform duration-300">
          ...
          <div className="mb-4 mt-4">
            <span className="inline-block text-yellow-800 text-lg font-bold mb-2">Premium</span>
          </div>
          <div className="mb-5">
            <span className="text-3xl font-extrabold text-gray-900">₹1,999</span>
            <span className="text-base text-gray-600 font-medium">/mo</span>
          </div>
          <ul className="text-gray-800 mb-6 space-y-2 text-left w-full max-w-xs mx-auto">
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> All Basic Features</li>
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> Personal Trainer</li>
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> Spa & Recovery</li>
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> Nutrition Plan</li>
          </ul>
          <button className="w-full py-2 bg-yellow-600 text-white rounded-xl font-semibold hover:bg-yellow-700 transition shadow-lg">Join Premium</button>
        </div>
        {/* Family */}
        <div className="flex-1 bg-white rounded-3xl shadow-xl border-2 border-yellow-400 p-6 flex flex-col items-center hover:scale-105 transition-transform duration-300">
          <div className="mb-3">
            <span className="inline-block text-yellow-700 text-lg font-bold mb-1">Family</span>
          </div>
          <div className="mb-5">
          ...
          <ul className="text-gray-700 mb-6 space-y-2 text-left w-full max-w-xs mx-auto">
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> All Premium Features</li>
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> 4 Family Members</li>
            <li className="flex items-center gap-2"><CheckIcon className="text-green-500" fontSize="small" /> Kids Zone</li>
          </ul>
          <button className="w-full py-2 bg-yellow-500 text-white rounded-xl font-semibold hover:bg-yellow-600 transition">Join Family</button>
        </div>
      </div>
    </div>
  </div>
